...
exports.NetworkError = exports.ApiError = exports.RateLimitError = exports.ForbiddenError = exports.UnauthorizedError = exports.ChakravyuhError = void 0;
exports.errorFromResponse = errorFromResponse;
// ─── Base Error ─────────────────────────────────────────────────
/** Base error for all CHAKRAVYUH SDK errors. */
class ChakravyuhError extends Error {
...
exports.ChakravyuhError = ChakravyuhError;
// ─── 401 Unauthorized ───────────────────────────────────────────
/** Thrown when authentication is missing or invalid (HTTP 401). */
class UnauthorizedError extends ChakravyuhError {
 ...
 * ```
 */
class ForbiddenError extends ChakravyuhError {
...
class RateLimitError extends ChakravyuhError {
...
class ApiError extends ChakravyuhError {
    constructor(message, code, status, requestId, details) {
...
class NetworkError extends ChakravyuhError {
