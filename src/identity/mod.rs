...
pub use auth::{AuthService, AuthError, Claims, JwtConfig, TokenPair};
...
pub use platform::{
    ...
    is_valid_api_key_format, ApiKey, AuditLog, Membership, Organization,
    Plan, PlatformStore, RefreshToken, User, Workspace,
};
