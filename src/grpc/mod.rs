...
impl proto::chakravyuh_service_server::ChakravyuhService for ChakravyuhGrpcService {
    ...
    async fn ready(&self, _request: Request<Empty>) -> Result<Response<ReadyResponse>, Status> {
        ...
        let infra_health: Vec<RingStatus> = ring_health
            .iter()
            .map(|h| RingStatus {
        ...
        let ring_health_for_check: Vec<RingHealth> = infra_health
            .iter()
            .map(|h| RingHealth {
                name: h.name.clone(),
                enabled: true,
    ...
    async fn submit_feedback(
        ...
        let feedback_type = match req.feedback_type.to_lowercase().as_str() {
            ...
            "false_negative" | "fn" => {
                crate::keshav::feedback_collector::FeedbackType::FalseNegative
            }
            "approve" => crate::keshav::feedback_collector::FeedbackType::Approve,
            "reject" => crate::keshav::feedback_collector::FeedbackType::Reject,
            "escalation_approved" => {
                crate::keshav::feedback_collector::FeedbackType::EscalationApproved
            }
            "escalation_denied" => {
        ...
        self.state
            .learn
            .submit_feedback(crate::keshav::feedback_collector::FeedbackEntry {
